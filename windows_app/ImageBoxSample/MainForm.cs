      ...
      this.UpdateStatusBar();
        ...
        private void ToolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            if (openFileDialog.ShowDialog()== DialogResult.OK )
            {
                ...
                imageBox.Image = new Bitmap(openFileDialog.FileName.ToString());
            }
        }
        ...
        {
            Bitmap ii = new Bitmap(imageBox.Image);
            Bitmap bitmap = new Bitmap(ii.Width*2, ii.Height*2);
            for (var x = 0; x < ii.Width; x++)
            {
                for (var y = 0; y < ii.Height; y++)
                {
                    bitmap.SetPixel(x, y, ii.GetPixel(x, y));
                }
            }
            for (var x = 0; x < ii.Width; x++)
            {
                for (var y = 0; y < ii.Height; y++)
                {
                    bitmap.SetPixel(ii.Width + x,  y, ii.GetPixel(x, y));
                }
            }
            for (var x = 0; x < ii.Width; x++)
            {
                for (var y = 0; y < ii.Height; y++)
                {
                    bitmap.SetPixel( x, ii.Height + y, ii.GetPixel(x, y));
                }
            }
            for (var x = 0; x < ii.Width; x++)
            {
                for (var y = 0; y < ii.Height; y++)
                {
                    bitmap.SetPixel(ii.Width+x, ii.Height+y, ii.GetPixel(x, y));
                }
            }
        ...
        private void ToolStripButton4_Click(object sender, EventArgs e)
        {
            ...
            for (int x = 0; x < ii.Width; x++)
            {
                for (var y = 0; y < ii.Height; y++)
                {
                    bitmap.SetPixel(bitmap.Width - x-1, y, ii.GetPixel(x, y));
                }
            }
            for (var x = 0; x < ii.Width; x++)
            {
                for (var y = 0; y < ii.Height; y++)
                {
                    bitmap.SetPixel(x, bitmap.Height - y-1, ii.GetPixel(x, y));
                }
            }
            for (var x = 0; x < ii.Width; x++)
            {
                for (var y = 0; y < ii.Height; y++)
                {
                    bitmap.SetPixel(bitmap.Width - x-1, bitmap.Height - y-1, ii.GetPixel(x, y));
                }
            }
            imageBox.Image = bitmap;
        }
